...
def banner():
    ...
    os.system("clear")
    autoketik("""
                --oo//MMMMMMMMMMMMMMMM\\oo--
             --oo//MMMMMMMMMMMMMMMMMMMMMM\\oo--
      ...
      `M:-ho`NMNNNNNNNNmho-sN:Ms-shmMNNNNNNNNNM`sh-/M`
       `Mh`+ sdMNNNNMh`     NMosMN     `dMMMMMdo`/`hN
        ...
        /d`/ss mNNNNN-      `d.-h`      -NNNNd ss/`d:
          ...
          ****        EXECUTOR TEAM CYBER        ****
-------------------------------------------------------------
        || \033[1;96mJangan Lupa Subscribe Channel Youtube ||
        || \033[1;96mMr. E-CYBER TEAM                      ||
        || Powered \033[1;96mExecutor Team Cyber           ||""")
    print(abu + '-' * os.get_terminal_size().columns, end=''*2)
    print (Fore.RED+""" • \033[1;97mCreator"""+Fore.RED+""" : \033[1;92mEXECUTOR TEAM CYBER""")
    print (Fore.RED+""" • \033[1;97mGithubb"""+Fore.RED+""" : \033[1;92mgithub.com/teamcyber-glitch""")
